...
<body>
    ...
    <div style="background-color: #C0C0C0; border-style: solid; border-width: 1px; margin: auto; width: 800px; padding: 10px">
        ...
        <asp:DropDownList ID="input1" runat="server" DataSourceID ="SqlDataSource1" DataTextField="Unit" DataValueField="Factor"></asp:DropDownList>
        is equals to
        <asp:TextBox ID="outputString" runat="server" style="width:147px"></asp:TextBox>
        <asp:DropDownList ID="output1" runat="server" DataSourceID="SqlDataSource1" DataTextField="Unit" DataValueField="Factor"></asp:DropDownList>
    <br/>
        <br />
